...
> Auto-generated by `pnpm memory:index` on 2026-07-01. Live snapshot loaded at session start.
> For the full catalogue, see [`INDEX.md`](INDEX.md).

## Recent sessions (top 3)

- **2026-07-01** — [Session — Patch des 19 incohérences UX de l'audit client](sessions/2026-07-01-1156.md)
...
- **2026-07-01** — [Patch d'incohérences UX (audit client juillet 2026) — 19 items, 14 commits](decisions/2026-07-01-audit-ux-patch.md) · #content #i18n #sanity #decision
...
- Full catalogue (197 entries): [`INDEX.md`](INDEX.md)
