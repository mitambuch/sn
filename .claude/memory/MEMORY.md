...
> Auto-generated by `pnpm memory:index` on 2026-05-12. Live snapshot loaded at session start.
> For the full catalogue, see [`INDEX.md`](INDEX.md).

## Recent sessions (top 3)

- **2026-05-12** — [Session addendum — Brand preloader baseline (22:00 → 22:40)](sessions/2026-05-12-2200-preloader-baseline-addendum.md)
