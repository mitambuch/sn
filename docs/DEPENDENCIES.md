...
| i18next                          | i18n runtime               | FR/DE/EN translation store and fallback handling             |
| i18next-browser-languagedetector | Locale detection           | Reads localStorage/navigator/html lang for first visit       |
