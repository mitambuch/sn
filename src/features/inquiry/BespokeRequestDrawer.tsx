...
//
// WHAT: A wide right-side drawer holding the most detailed inquiry form
//       in the product. Captures domain (multi-select chips), free-form
//       description, budget min/max + currency, urgency, optional target
//       date, photo attachments, and a privacy acknowledgement. Designed
//       for the "we don't have what you want — describe it" moment.
    ...
    >
      ...
      >
        ...
        >
          ...
          {/* ─── Photos ─── */}
          <ImageUpload
            label={t('bespoke.attachLabel')}
            hint={t('bespoke.attachHint')}
            maxFiles={5}
          />
