...
//
// WHAT: Right-side drawer with a from/to + dates + pax form, designed
//       to feel like an aviation desk request — not a flight-search
//       widget. Submit triggers a fake transmission with toast confirmation
//       and the standard "Salva confirme la disponibilité sous 30 minutes"
//       reassurance line.
