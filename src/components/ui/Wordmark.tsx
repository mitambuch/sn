// ═══════════════════════════════════════════════════
// Wordmark — full SAWNEXT logotype with the signature ↗ arrow
//
// WHAT: Renders the SVG wordmark inline, fill=currentColor so it
//       inherits text-fg / text-accent / any text-* utility.
// WHEN: Hero brand mark, large displays, OG image. For compact
//       contexts use <Logomark /> (S↗N monogram) instead.
// CHANGE COLOR: set `text-fg`, `text-accent`, or any text-* class on
//               the parent — the SVG paths inherit via currentColor.
// CHANGE SIZE: width/height via className (h-12, w-full, etc.) or
//              CSS — the SVG preserves its aspect ratio.
// ═══════════════════════════════════════════════════
...
/** Full SAW Next logotype. Use for hero brand reveals and OG cards. */
export const Wordmark = ({ className, ariaLabel = 'SAW Next' }: WordmarkProps) => {
  return (
    <svg
