...
export function LocaleProvider({ children }: { children: ReactNode }) {
  ...
  const setLocale = useCallback(
    (next: Locale) => {
      ...
      // WHY: preserve search+hash so switching /fr/playground?tab=buttons#hero
      // to DE stays on ?tab=buttons#hero instead of resetting state.
      ...
      void navigate(`${localePath(next, rest)}${search}${hash}`);
    },
    [locale, params.locale, pathname, search, hash, navigate],
  );
