...
const LoaderShowcase = lazyWithRetry(() => import('@pages/LoaderShowcase'));
  ...
  return (
    <Suspense fallback={<PageLoader />}>
      <Routes>
        ...
        {/* ─── /loader — archive SAW NEXT stroke-draw loader (from feat/landing-mvp) ─── */}
        <Route path="/loader" element={<LoaderShowcase />} />
