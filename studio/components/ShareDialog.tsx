        ...
        <Stack space={4}>
          ...
          <Card padding={3} radius={2} tone="primary">
            <Stack space={3}>
              ...
              <Text size={1}>
                <strong>🔑 Code de partage</strong> — un code <Code size={1}>XXXXXX</Code> donne
                accès à cette fiche seule, sans authentification.
              </Text>
            </Stack>
          </Card>
        </Stack>
  ...
  return (
    <Box padding={4}>
      <Stack space={4}>
        ...
        <Text size={1} muted>
          Cette fiche est configurée pour le partage par code. Un code <Code size={1}>XXXXXX</Code>{' '}
          donne accès à cette fiche seule, sans authentification. Tu peux en générer plusieurs (un
          par destinataire) et choisir une date d&apos;expiration ou un nombre de vues maximum.
        </Text>
        ...
        <Card padding={3} radius={2} tone="primary">
          <Stack space={3}>
            ...
            <Text size={1}>
              3. Le code et l&apos;URL <Code size={1}>/share/XXXXXX</Code> sont prêts à être envoyés
              sur WhatsApp.
            </Text>
          </Stack>
        </Card>
